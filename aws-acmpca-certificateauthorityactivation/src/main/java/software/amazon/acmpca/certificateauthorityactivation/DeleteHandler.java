...
public final class DeleteHandler extends BaseHandler<CallbackContext> {
    ...
    public ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        log.log("Delete handler being invoked for Arn: " + model.getCertificateAuthorityArn());

        try {
            acmPcaClient.disableCertificateAuthority(model);
        } catch (InvalidStateException | ResourceNotFoundException ex) {
