...
public abstract class TestBase {
    ...
    protected static final String certificateChain = "valid-chain";
    protected static final String defaultTemplateArn = "arn:aws:acm-pca:::template/EndEntityCertificate/V1";
