...
public class CreateHandlerTest extends TestBase {
    ...
    public void testHandleRequest__Success() {
        ...
        doReturn(new ListPermissionsResult().withPermissions(ImmutableList.of()))
                .when(proxy).injectCredentialsAndInvoke(any(ListPermissionsRequest.class), any(Function.class));
    ...
    @Test
    @SuppressWarnings("unchecked")
    public void testHandleRequest__PermissionAlreadyExists() {
        val handler = new CreateHandler();
        ...
        doReturn(new ListPermissionsResult().withPermissions(permission))
                .when(proxy).injectCredentialsAndInvoke(any(ListPermissionsRequest.class), any(Function.class));
